...
export const SignInPage = ({ className }: SignInPageProps) => {
    ...
    // Reuse "code" step as "password" step for visual consistency but logical adaptation
    ...
    const handlePasswordSubmit = async (e: React.FormEvent) => {
        ...
        // Trigger "reverse" animation for effect before submitting
                    ...
                    <div className="w-full mt-[100px] max-w-sm px-4">
                        <AnimatePresence mode="wait">
                            {step === "email" && (
                                ...
                                >
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xl text-white/70">Enter your email</p>
                                    </div>
                            ...
                            {step === "password" && (
                                ...
                                >
                                    <div className="space-y-1">
                                        <h1 className="text-4xl font-bold text-white">Password</h1>
                                        <p className="text-xl text-white/70">Enter your password</p>
                                    </div>
